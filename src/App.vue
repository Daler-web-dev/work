	...
	<div class="app">
		<div class="screen-one">
			...
			<div class="app-main">
				...
				<div class="products">
					<productItem v-for="product of products" :key="product.id" v-bind:productValue="product" @toCart="toCart"/>
				</div>
			</div>
		</div>
		<div class="screen-two">
			<div class="cart">
				<h2>CART #1</h2>
				<div class="coloumn">
					<selecteditem class="cart-item" v-for="item of carts" :key="item.id" v-bind:transferValue="item"/>
				</div>
			</div>
			<div class="card">
				<div class="prices">
  ...
  data() {
    return {
        ...
        },
        {
          ...
          id: Math.random(),
          image: 'sds',
          title: 'футболки dalsld',
          price: 15,
          quantity: 2121
        },{ 
          id: Math.random(),
          image: 'sds',
          title: 'футболки dsadad',
          price: 15,
          quantity: 2121
        },{
          id: Math.random(),
	...
	methods: {
    	toCart(data) {
			let d = this.products.filter(product => product.id == data)[0]
			d.number = this.carts.length + 1
			this.carts.push(d)
